...
part 'comment_forum_model.g.dart';

@JsonSerializable(nullable: true)
class CommentForumModel {
  int status;
  Data data;

  CommentForumModel({this.status, this.data});

  factory CommentForumModel.fromJson(Map<String, dynamic> json) =>
      _$CommentForumModelFromJson(json);

  Map<String, dynamic> toJson() => _$CommentForumModelToJson(this);
}
